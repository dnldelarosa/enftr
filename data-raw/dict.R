dict0 <- list(
  ...
  S2_P2A = list(
    lab = "Material predominante en las paredes",
    labs = c(
      "Asbesto" = 1, "Block" = 2, "Cart\\u00F3n" = 3, "Concreto Armado" = 4,
      "Ladrillo" = 5, "Madera" = 6, "Mixto (block y madera)" = 7, "Plywood" = 8,
      "Tabla de Palma" = 9, "Tejamanil" = 10, "Yagua" = 11, "Zinc" = 12,
      "Materiales de desecho" = 13, "Otro" = 99
    )
  ...
  S2_P2D = list(
    lab = "Material predominante en el piso",
    labs = c(
      "Cemento" = 1, "Cer\\u00E1mica" = 2, "Granito" = 3, "Ladrillo" = 4,
  ...
  S2_P7A = list(
    lab = "¿Qu\u00E9 tipo de alumbrado se utiliza principalmente en esta vivienda?",
    labs = c(
      "Electricidad de las empresas (CDEE/EDES)" = 1, "Generaci\\u00F3n privada" = 2,
...
dict1 <- list(
  ...
  empleado = list(
    lab = "Población ocupada y empleada",
    labs = c("Empleado" = 1, "No empleado" = 0)
  ),
  formalidad_afiliacion = list(
    lab = "Formalidad de afiliación a la seguridad social",
